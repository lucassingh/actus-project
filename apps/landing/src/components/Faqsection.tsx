                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                            <button className="w-full sm:w-auto px-6 md:px-10 py-3 md:py-5 bg-accent hover:bg-accent/90 text-white font-bold rounded-2xl transition-all shadow-xl shadow-accent/20 hover:scale-105 active:scale-95 text-base md:text-lg">
                                Agendar reunión
                            </button>
                        </div>
                    </div>
