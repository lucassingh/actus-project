        ...
        <div className="w-full max-w-[1334px] mx-auto p-4">
            ...
            >
                <defs>
                    ...
                    <filter id="glowBlue">
                        <feGaussianBlur stdDeviation="4" result="coloredBlur" />
                        <feFlood floodColor="#1A3A8A" floodOpacity="0.6" result="color" />
                        <feComposite in="color" in2="coloredBlur" operator="in" result="shadow" />
                        <feMerge>
                            <feMergeNode in="shadow" />
                            <feMergeNode in="SourceGraphic" />
                ...
                >
                    ...
                    <text x="140" y="40" fill="#0A2463" fontSize="14" fontWeight="600" fontFamily="system-ui, -apple-system, sans-serif">Producción al máximo rendimiento</text>
                ...
                >
                    ...
                    <text x="535" y="40" fill="#0A2463" fontSize="14" fontWeight="600" fontFamily="system-ui, -apple-system, sans-serif">Maquina industrial</text>
          ...
          `}
                ...
                >
                    ...
                    <path d="M829.5 249.5C840.811 249.5 850 258.891 850 270.5C850 282.109 840.811 291.5 829.5 291.5C818.189 291.5 809 282.109 809 270.5C809 258.891 818.189 249.5 829.5 249.5Z" stroke="#1A3A8A" />
                    <path d="M836.167 280C836.167 277.878 835.289 275.843 833.726 274.343C832.163 272.843 830.043 272 827.833 272M827.833 272C825.623 272 823.504 272.843 821.941 274.343C820.378 275.843 819.5 277.878 819.5 280M827.833 272C830.71 272 833.042 269.761 833.042 267C833.042 264.239 830.71 262 827.833 262C824.957 262 822.625 264.239 822.625 267C822.625 269.761 824.957 272 827.833 272ZM840.333 279C840.333 275.63 838.25 272.5 836.167 271C836.851 270.507 837.399 269.859 837.761 269.114C838.123 268.369 838.288 267.55 838.242 266.73C838.195 265.909 837.939 265.112 837.495 264.409C837.052 263.706 836.434 263.119 835.698 262.7" stroke="#1A3A8A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    {/* Text */}
                    <text x="862" y="264" fill="#0A2463" fontSize="12" fontWeight="600" fontFamily="system-ui, -apple-system, sans-serif">Consulta a sus compañeros</text>
                ...
                >
                    ...
                    {/* Text */}
                    <text x="1130" y="103" fill="#0A2463" fontSize="11" fontWeight="600" fontFamily="system-ui, -apple-system, sans-serif">Manuales desactualizados</text>
                ...
                >
                    ...
                    {/* Text */}
                    <text x="1130" y="184" fill="#0A2463" fontSize="11" fontWeight="600" fontFamily="system-ui, -apple-system, sans-serif">Esta en otra planta</text>
                ...
                >
                    ...
                    {/* Text */}
                    <text x="1130" y="264" fill="#0A2463" fontSize="11" fontWeight="600" fontFamily="system-ui, -apple-system, sans-serif">Diversas opiniones</text>
                ...
                >
                    ...
                    <path d="M829.5 331.5C840.811 331.5 850 340.891 850 352.5C850 364.109 840.811 373.5 829.5 373.5C818.189 373.5 809 364.109 809 352.5C809 340.891 818.189 331.5 829.5 331.5Z"
                        stroke={animationPhase >= TIMING.CENTER_SOLUTION_PULSE ? "#37CF83" : "#1A3A8A"} // ← El icono interior sí es azul
                    />
                    ...
                    />
                    {/* Text */}
                    <text x="862" y="345" fill="#0A2463" fontSize="12" fontWeight="600" fontFamily="system-ui, -apple-system, sans-serif">Implementa la solución</text>
                ...
                >
                    ...
                    <circle cx="688.5" cy="274" r="20.5" stroke="#F97316" />
                    <path d="M688.75 267.5V274.25L693.25 276.5M700 274.25C700 280.463 694.963 285.5 688.75 285.5C682.537 285.5 677.5 280.463 677.5 274.25C677.5 268.037 682.537 263 688.75 263C694.963 263 700 268.037 700 274.25Z" stroke="#F97316" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <text x="480" y="268" fill="#0A2463" fontSize="12" fontWeight="600" fontFamily="system-ui, -apple-system, sans-serif">Tiempo perdido</text>
                ...
                >
                    ...
                    <circle cx="688.5" cy="354.5" r="20.5" stroke="#F97316" />
                    <path d="M680.795 346.295L696.704 362.205M700 354.25C700 360.463 694.963 365.5 688.75 365.5C682.537 365.5 677.5 360.463 677.5 354.25C677.5 348.037 682.537 343 688.75 343C694.963 343 700 348.037 700 354.25Z" stroke="#F97316" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <text x="480" y="348" fill="#0A2463" fontSize="12" fontWeight="600" fontFamily="system-ui, -apple-system, sans-serif">Producción detenida</text>
                ...
                >
                    <circle
                        ...
                        cy="568"
                        r="33.5"
                        stroke={animationPhase >= TIMING.GREEN_CENTER_PULSE ? "#37CF83" : "#1A3A8A"} // Azul hasta que llegue, luego verde
                        strokeWidth="2"
                    />
                    <path
                ...
                {/* Right - Chart icon */}
                <circle cx="980.5" cy="568" r="33.5" stroke="#1A3A8A" />
                <path d="M982.083 575.417V563.75M989.375 575.417V571.042M967.5 555V578.333C967.5 579.107 967.807 579.849 968.354 580.396C968.901 580.943 969.643 581.25 970.417 581.25H993.75M974.792 575.417V557.917" stroke="#1A3A8A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <text x="1025" y="562" fill="#0A2463" fontSize="13" fontWeight="600" fontFamily="system-ui, -apple-system, sans-serif">El supervisor no tiene control </text>
                ...
                <text x="630" y="562" fill="#0A2463" fontSize="13" fontWeight="600" fontFamily="system-ui, -apple-system, sans-serif">Pérdida de dinero</text>
                ...
                {/* ===== CONNECTION LINES ===== */}
                {/* Company to Factory */}
                <path d="M398.5 47H449.5" stroke="#0A2463" strokeWidth="1.5" strokeLinecap="round" />
                {/* Factory to Technician */}
                <path d="M585.5 92V142" stroke="#0A2463" strokeWidth="1.5" strokeLinecap="round" />
                {/* Technician to Solutions (curved) */}
                <path d="M722.5 178.742C787.905 184.059 747.486 105.478 801.5 110.205" stroke="#0A2463" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M722.5 190H801.5" stroke="#0A2463" strokeWidth="1.5" strokeLinecap="round" />
                <path d="M722.5 200.262C787.905 194.868 747.486 274.587 801.5 269.792" stroke="#0A2463" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                {/* Solutions to Responses */}
                <path d="M1060.5 110H1111.5" stroke="#0A2463" strokeWidth="1.5" strokeLinecap="round" />
                <path d="M1060.5 190H1111.5" stroke="#0A2463" strokeWidth="1.5" strokeLinecap="round" />
                <path d="M1060.5 270.5H1111.5" stroke="#0A2463" strokeWidth="1.5" strokeLinecap="round" />
                {/* Right side vertical and horizontal - curved */}
                <path d="M1060.5 352H1333.5Q1348.5 352 1348.5 337V270.5Q1348.5 255.5 1333.5 255.5H1314.5" stroke="#0A2463" strokeWidth="1.5" strokeLinecap="round" fill="none" />
                {/* Bottom connections - curved loop */}
                <path d="M43.5 568H0.5Q-14.5 568 -14.5 553V47Q-14.5 32 0.5 32H43.5" stroke="#0A2463" strokeWidth="1.5" strokeLinecap="round" fill="none" />
                {/* Center solution to technician responses (curved) */}
                <path d="M801.5 342.742C736.095 348.059 776.514 269.478 722.5 274.205" stroke="#0A2463" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M722.5 355H801.5" stroke="#0A2463" strokeWidth="1.5" strokeLinecap="round" />
                <path d="M801.5 365.258C736.095 359.941 776.514 438.522 722.5 433.795" stroke="#0A2463" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                {/* Technician responses to bottom - curved */}
                <path d="M449.5 357H363.5Q348.5 357 348.5 372V522" stroke="#0A2463" strokeWidth="1.5" strokeLinecap="round" fill="none" />
                <path d="M449.5 274H319.5Q304.5 274 304.5 289V522" stroke="#0A2463" strokeWidth="1.5" strokeLinecap="round" fill="none" />
                <path d="M449.5 434H406.5Q391.5 434 391.5 449V522" stroke="#0A2463" strokeWidth="1.5" strokeLinecap="round" fill="none" />
