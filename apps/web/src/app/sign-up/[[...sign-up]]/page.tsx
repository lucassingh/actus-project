    ...
    <div className="min-h-screen bg-linear-to-br from-[#242F5B] via-[#2B3870] to-[#161D3A] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md flex flex-col items-center">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-blue-300 text-sm">Creá tu cuenta y empezá hoy</p>
        </div>
        ...
        <p className="mt-6 text-blue-400 text-xs text-center">
          ¿Ya tenés cuenta?{" "}
          <Link href="/sign-in" className="text-[#EA580E] hover:text-orange-300 font-semibold transition-colors">
            Iniciá sesión
          </Link>
        </p>
      </div>
