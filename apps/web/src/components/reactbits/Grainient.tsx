'use client';
// Adapted from React Bits (Grainient, TS + Tailwind). Changes: single static frame under
// prefers-reduced-motion, re-render after prop sync (first frame already uses brand colors),
// DPR capped at 1.5, typed uniforms.
